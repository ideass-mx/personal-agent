...
const FORBIDDEN =
  /\b(ActiveWorkspace|activeWorkspaceId|WorkspaceManager|WorkspaceRegistry|ConversationManager|ConversationContext|NodeRegistry|A2A)\b/;
...
describe("PHASE 22 listado Conversation por Workspace", () => {
  it("no mete Workspace en WS, Runtime, AgentTurnInput ni ToolContext", () => {
    ...
    const tools = readFileSync(
      path.join(repoRoot, "gateway/src/tools/types.ts"),
      "utf8",
    );
