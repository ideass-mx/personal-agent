...
- **Fase 1 · El canal** — Agent API `api/` (✔ semilla; antes `hub/`) + app Android chat texto.
  Éxito: mensaje desde la calle → api → Claude → respuesta; y la conexión
...
- **Fase 4 · Las garras** — agente Windows (gateway MCP, Guardián, shell,
  files, system) + router en el api. Éxito: "¿cuánta RAM libre tengo?" desde los buds.
