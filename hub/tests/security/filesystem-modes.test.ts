...
import {
  FILESYSTEM_LIST,
} from "../../../agent/src/tools/filesystem-list.ts";
import {
  FILESYSTEM_READ,
} from "../../../agent/src/tools/filesystem-read.ts";
import {
  FILESYSTEM_WRITE,
} from "../../../agent/src/tools/filesystem-write.ts";
import { createFilesystemListTool } from "../../../agent/src/tools/filesystem-list.ts";
import { createFilesystemReadTool } from "../../../agent/src/tools/filesystem-read.ts";
import { createFilesystemWriteTool } from "../../../agent/src/tools/filesystem-write.ts";
import {
  createAgentRuntime,
  type AgentEvent,
  type TurnMemory,
