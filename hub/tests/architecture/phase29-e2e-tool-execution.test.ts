...
describe("PHASE 29 E2E tool execution (audit)", () => {
  ...
  it("discovery: policy executionMode; generic LLM schema; MCP envelope", () => {
    ...
    const defaults = readFileSync(
      path.join(repoRoot, "agent/src/extensions/defaults.ts"),
      "utf8",
    );
