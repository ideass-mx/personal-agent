...
describe("PHASE 1 fronteras Agent Platform", () => {
  ...
  it("F no hay un segundo Agent Runtime por especialización", () => {
    ...
    const runtimeFiles = walkTs(path.join(repoRoot, "hub/src/agent")).filter(
  ...
  it("G no existe carpeta node/ de producto", () => {
